  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Yuvaraj D",
        text: "Hello, I'm a Full-stack ASP.Net Web Developer with 5+ years of experience designing web and mobile projects. Find out more in my live-resume!",
